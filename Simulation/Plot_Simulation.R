...
#Define which colours to use for each method
...
#Create data frame for ME probabilities (realistic 7%, Y1/Y3)
...
#Create data frame for ME probabilities (realistic 7%, Y2/Y4)
...
# Expected value (all)
plot_df %>% ggplot( aes(x=indicator, y=prop, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="Model",values=colours) + labs(y= "Expected value", x = "Number of indicators") + facet_grid(Contract+N ~ ME,labeller=label_both) + geom_hline(aes(yintercept=hline), color = "black",linewidth=0.3) + geom_errorbar(aes(ymin=prop-sd, ymax=prop+sd), width=.25, size=0.3, position=position_dodge(.9))+ theme(legend.position="top")

# RMSE (all)
plot_df %>% ggplot( aes(x=indicator, y=rmse, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="Model",values=colours) + labs(y= "RMSE", x = "Number of indicators") + facet_grid(Contract+N ~ ME,labeller=labeller(.rows=label_value,.cols=label_both)) + theme(legend.position="top")

# Expected value (permanent and n=1,000)
plot_df[plot_df$N==1000&plot_df$Contract=="Permanent",] %>% ggplot( aes(x=indicator, y=prop, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="",values=colours) + labs(y= "Expected\nvalue", x = "Number of indicators") + facet_wrap(~ME,ncol=4,labeller=label_value) + geom_hline(aes(yintercept=hline), color = "black",size=0.3)+ theme(legend.position="top") + geom_errorbar(aes(ymin=prop-sd, ymax=prop+sd), width=.25, size=0.3, position=position_dodge(.9)) +  guides(fill = guide_legend(direction = "horizontal")) + theme(plot.title = element_text(size = 13),legend.justification="right")

# RMSE (permanent and n=1,000)
plot_df[plot_df$N==1000&plot_df$Contract=="Permanent",] %>% ggplot( aes(x=indicator, y=rmse, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="",values=colours) + labs(y= "Expected\nvalue", x = "Number of indicators") + facet_wrap(~ME,ncol=4,labeller=label_value) + theme(legend.position="top") +  guides(fill = guide_legend(direction = "horizontal")) + theme(plot.title = element_text(size = 13),legend.justification="right")
...
# Expected value (all)
plot_ME %>% ggplot( aes(x=indicator, y=ME1, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="Model",values=colours) + labs(y= "(Mean) expected value", x = "Number of indicators")  + geom_errorbar(aes(ymin=ME1-sd_ME1, ymax=ME1+sd_ME1), width=.25, size=0.3, position=position_dodge(.9))+ facet_grid(Contract+N ~ ME,labeller=label_both) + geom_hline(aes(yintercept=mline), color = "black",size=0.3 ) + theme(legend.position="top")

# RMSE (all)
plot_rmse_ME %>% ggplot( aes(x=indicator, y=rmse, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="Model",values=colours) + labs(y= "RMSE", x = "Number of indicators") + facet_grid(Contract+N ~ ME,labeller=labeller(.rows=label_both,.cols=label_both)) + theme(legend.position="top")

# Expected value (permanent and n=1,000)
plot_ME[plot_ME$N==1000&plot_ME$Contract=="Permanent",] %>% ggplot( aes(x=indicator, y=ME1, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="",values=colours) + labs(y= "(Mean) expec-\nted value", x = "Number of indicators") + theme(legend.position="top") + geom_errorbar(aes(ymin=ME1-sd_ME1, ymax=ME1+sd_ME1), width=.25, size=0.3, position=position_dodge(.9)) +  guides(fill = guide_legend(direction = "horizontal"))   + theme(plot.title = element_text(size = 13),legend.position=c(1,1.65),legend.justification="right") + facet_wrap(~ME,ncol=5,labeller=label_value) + geom_hline(aes(yintercept=mline), color = "black",size=0.3 )

# RMSE (permanent and n=1,000)
plot_rmse_ME[plot_rmse_ME$N==1000&plot_rmse_ME$Contract=="Permanent",]  %>% ggplot( aes(x=indicator, y=rmse, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="Model",values=colours)  + labs(y= "(Mean)\n RMSE", x = "Number of indicators") +guides(fill = guide_legend(direction = "horizontal")) + theme(plot.title = element_text(size = 13),legend.position="top")+ facet_wrap(~ ME,ncol=5,labeller=label_value)
...
#Entropy R2 (all)
plot_df[plot_df$type!="tree-MILC",] %>% ggplot( aes(x=indicator, y=entropy,fill=type)) + geom_bar(stat='identity', position='dodge')+ scale_fill_manual(name="Model",values=colours) + labs(y= "Mean entropy R-Squared", x = "Number of indicators")+ facet_grid(rows = vars(N),cols=vars(ME),labeller=label_both) + theme(legend.position="top")

#Entropy R2 (n=1,000)
plot_df[plot_df$type!="tree-MILC"&plot_df$N==1000,] %>% ggplot( aes(x=indicator, y=entropy,fill=type)) + geom_bar(stat='identity', position='dodge')+ scale_fill_manual(name="Model",values=colours) + labs(y= "Mean entropy R-Squared", x = "Number of indicators") + facet_wrap(~ME,ncol=4,labeller=label_both) + theme(legend.position="top")

##################################################################################################
## Plot mean summed bias                                                                        ##
##################################################################################################

plot_df %>% ggplot( aes(x=indicator, y=diag, fill=type)) + geom_bar(stat='identity', position='dodge')  + scale_fill_manual(name="",values=colours)+ labs(y= "Mean summed bias", x = "Number of indicators") + facet_wrap(~ ME,ncol=5,labeller=label_value) + theme(legend.position="top")
  ...
  for(m in cov_problem){
    for(k in ind){
      if(k==2){
        ...
        bias1 = get_ME_heatmap(LC_models,LCT_models,treeMILC_models,LC_results,1,k,cov_ok, cov_problem,j) # Bias (10%, 20%, 30% ME)
        variance1 = get_ME_heatmap(LC_models,LCT_models,treeMILC_models,LC_results,2,k,cov_ok, cov_problem,j) # Variance (10%, 20%, 30% ME)
        bias2 = get_ME_heatmap_realistic(LC_models,LCT_models,treeMILC_models,LC_results,1,k,cov_ok, cov_problem,j) # Bias (realistic 7% ME)
        variance2 = get_ME_heatmap_realistic(LC_models,LCT_models,treeMILC_models,LC_results,1,k,cov_ok, cov_problem,j) # Variance (realistic 7% ME)
    }  
  }
}