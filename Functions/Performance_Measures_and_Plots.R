...
get_var_ME = function(models, ind, cov_ok, cov_problem, N, ME, ind_type = NULL) {
  ...
  for (i in select_inds) {
    ...
    # Create vector to store variances in
    var_vec = vector()
    ...
    # Convert variance vector to a matrix and add to return list
...
get_rmse_ME_help = function(model_list,indicator,contract){
  ...
  #For realistic amount of ME, get correct true value (for Y1/Y3 or Y2/Y4)
  ...
  #For 10%, 20% and 30%, get true value
  } else {
...
#- Alle Sim4 function_methods
#- Real data
#- Simulation bestandjes
#- Plot code
#- ReadMe
